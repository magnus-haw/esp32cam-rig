...
void setup() {
  ...
  // esphome:
  //   name: nasa17
  //   build_path: .esphome/build/nasa17
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa17", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa17.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa17.local");
  ...
  // ota:
  //   password: ca17044f3f8a6af030c9193df190ff09
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("ca17044f3f8a6af030c9193df190ff09");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: M0LAkiVAL5WlqANVE0dv2p9nY+BPF4Tp+fF6na3DXzo=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({51, 66, 192, 146, 37, 64, 47, 149, 165, 168, 3, 85, 19, 71, 111, 218, 159, 103, 99, 224, 79, 23, 132, 233, 249, 241, 122, 157, 173, 195, 95, 58});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA17");
