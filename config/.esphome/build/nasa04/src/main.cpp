...
void setup() {
  ...
  // esphome:
  //   name: nasa04
  //   build_path: .esphome/build/nasa04
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa04", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa04.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa04.local");
  ...
  ota_otacomponent->set_auth_password("6e77e68a5731c6285d465c2a3d527929");
  ...
  api_apiserver->set_noise_psk({51, 89, 210, 78, 218, 60, 153, 239, 190, 141, 95, 22, 173, 52, 137, 139, 186, 114, 199, 210, 227, 125, 215, 178, 213, 234, 94, 251, 235, 196, 9, 219});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA04");
