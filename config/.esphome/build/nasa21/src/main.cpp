...
void setup() {
  ...
  // esphome:
  //   name: nasa21
  //   build_path: .esphome/build/nasa21
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa21", __DATE__ ", " __TIME__, false);
  // light:
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  ...
  // ota:
  //   password: 1e4fbffd49fa0165707e6b6c98e084f9
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("1e4fbffd49fa0165707e6b6c98e084f9");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: UFmWZPF+/QVNz8FQ0XyzLaFJfiQVT7Rgt84yhpH0TNs=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({80, 89, 150, 100, 241, 126, 253, 5, 77, 207, 193, 80, 209, 124, 179, 45, 161, 73, 126, 36, 21, 79, 180, 96, 183, 206, 50, 134, 145, 244, 76, 219});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA21");
