...
void setup() {
  ...
  // esphome:
  //   name: nasa11
  //   build_path: .esphome/build/nasa11
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa11", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa11.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa11.local");
  ...
  // ota:
  //   password: eaa89cbb96a47ab8b57c6c88e0860dad
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("eaa89cbb96a47ab8b57c6c88e0860dad");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: xfRiufn9UImVfd8bSQj6eoPOLuZ2H5emx7SptaGX4X0=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({197, 244, 98, 185, 249, 253, 80, 137, 149, 125, 223, 27, 73, 8, 250, 122, 131, 206, 46, 230, 118, 31, 151, 166, 199, 180, 169, 181, 161, 151, 225, 125});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA11");
