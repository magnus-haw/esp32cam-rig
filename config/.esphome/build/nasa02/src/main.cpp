...
void setup() {
  ...
  // esphome:
  //   name: nasa02
  //   build_path: .esphome/build/nasa02
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa02", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa02.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa02.local");
  ...
  ota_otacomponent->set_auth_password("afa180ee19fc54a3d8e795e54b16cbf2");
  ...
  api_apiserver->set_noise_psk({107, 67, 157, 219, 217, 192, 43, 215, 68, 147, 203, 109, 162, 202, 92, 234, 251, 109, 169, 85, 119, 179, 234, 51, 77, 158, 69, 146, 237, 15, 6, 98});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA02");
