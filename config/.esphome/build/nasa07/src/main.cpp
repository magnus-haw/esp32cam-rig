...
void setup() {
  ...
  // esphome:
  //   name: nasa07
  //   build_path: .esphome/build/nasa07
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa07", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa07.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa07.local");
  ...
  // ota:
  //   password: b39830f1130be2fc089e473c8093d8fd
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("b39830f1130be2fc089e473c8093d8fd");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: KTmt2BIzmJ8cpD49nwn8Tg2zmpukMYuJD3UVUpWIAxM=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({41, 57, 173, 216, 18, 51, 152, 159, 28, 164, 62, 61, 159, 9, 252, 78, 13, 179, 154, 155, 164, 49, 139, 137, 15, 117, 21, 82, 149, 136, 3, 19});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA07");
