...
void setup() {
  ...
  // esphome:
  //   name: nasa08
  //   build_path: .esphome/build/nasa08
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa08", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa08.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa08.local");
  ...
  // ota:
  //   password: 1c107340dba61250c09b11ee23004fd2
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("1c107340dba61250c09b11ee23004fd2");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: tECQjTpPlXjEQvkYfLZO5GcJjP7veC4meUHW6SF4n7A=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({180, 64, 144, 141, 58, 79, 149, 120, 196, 66, 249, 24, 124, 182, 78, 228, 103, 9, 140, 254, 239, 120, 46, 38, 121, 65, 214, 233, 33, 120, 159, 176});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA08");
