...
void setup() {
  ...
  // esphome:
  //   name: nasa09
  //   build_path: .esphome/build/nasa09
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa09", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa09.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa09.local");
  ...
  // ota:
  //   password: 47f1abf4b53faf36847b8fb03cd0852d
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("47f1abf4b53faf36847b8fb03cd0852d");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: SIpYjDhsCCdpGAkvE6T8fvRnnL+88+IhUYyKQTyOMcQ=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({72, 138, 88, 140, 56, 108, 8, 39, 105, 24, 9, 47, 19, 164, 252, 126, 244, 103, 156, 191, 188, 243, 226, 33, 81, 140, 138, 65, 60, 142, 49, 196});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA09");
