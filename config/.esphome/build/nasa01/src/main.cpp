...
void setup() {
  ...
  // esphome:
  //   name: nasa01
  //   build_path: .esphome/build/nasa01
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa01", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  // wifi:
  //   ap:
  //     ssid: Nasa01 Fallback Hotspot
  //     password: CMD2MjAcQFKZ
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: nasa01.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa01.local");
  wifi::WiFiAP wifi_wifiap_2 = wifi::WiFiAP();
  wifi_wifiap_2.set_ssid("shadowfax");
  wifi_wifiap_2.set_password("shadowfax");
  wifi_wifiap_2.set_priority(0.0f);
  wifi_wificomponent->add_sta(wifi_wifiap_2);
  wifi::WiFiAP wifi_wifiap = wifi::WiFiAP();
  wifi_wifiap.set_ssid("Nasa01 Fallback Hotspot");
  wifi_wifiap.set_password("CMD2MjAcQFKZ");
  ...
  // ota:
  //   password: 7fd0aedac557b247518be8448cf971c8
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("7fd0aedac557b247518be8448cf971c8");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: eL3AolCl0HesC1toc6UEn+CG8ahntSW0q0sDUqOYIcs=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({120, 189, 192, 162, 80, 165, 208, 119, 172, 11, 91, 104, 115, 165, 4, 159, 224, 134, 241, 168, 103, 181, 37, 180, 171, 75, 3, 82, 163, 152, 33, 203});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA1");
