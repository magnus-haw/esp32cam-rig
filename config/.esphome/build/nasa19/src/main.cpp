...
void setup() {
  ...
  // esphome:
  //   name: nasa19
  //   build_path: .esphome/build/nasa19
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa19", __DATE__ ", " __TIME__, false);
  // light:
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  ...
  // ota:
  //   password: 4a6416410c2bbfaf30e15e5d25095162
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("4a6416410c2bbfaf30e15e5d25095162");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: kCrEpKAdGfJsUfEMgUfYNELu397X+GhgBADo73P0cnA=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({144, 42, 196, 164, 160, 29, 25, 242, 108, 81, 241, 12, 129, 71, 216, 52, 66, 238, 223, 222, 215, 248, 104, 96, 4, 0, 232, 239, 115, 244, 114, 112});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA19");
