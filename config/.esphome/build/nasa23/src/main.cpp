...
void setup() {
  ...
  // esphome:
  //   name: nasa23
  //   build_path: .esphome/build/nasa23
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa23", __DATE__ ", " __TIME__, false);
  // light:
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  ...
  // ota:
  //   password: fd90bd33e6d25055f27e0371bddc8510
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("fd90bd33e6d25055f27e0371bddc8510");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: bKFbvJDR9o45lDBIgIqd92qOuRUxKr6a4Z4rIeLTNI4=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({108, 161, 91, 188, 144, 209, 246, 142, 57, 148, 48, 72, 128, 138, 157, 247, 106, 142, 185, 21, 49, 42, 190, 154, 225, 158, 43, 33, 226, 211, 52, 142});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA23");
