...
void setup() {
  ...
  // esphome:
  //   name: nasa10
  //   build_path: .esphome/build/nasa10
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa10", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa10.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa10.local");
  ...
  // ota:
  //   password: 213c49ea82598aa57d6326dfacdefb9c
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("213c49ea82598aa57d6326dfacdefb9c");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: fNZedU5biRd8KZcqNw8cOW6X0WU1AUBjlh+OktkEqNM=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({124, 214, 94, 117, 78, 91, 137, 23, 124, 41, 151, 42, 55, 15, 28, 57, 110, 151, 209, 101, 53, 1, 64, 99, 150, 31, 142, 146, 217, 4, 168, 211});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA10");
