...
void setup() {
  ...
  // esphome:
  //   name: nasa13
  //   build_path: .esphome/build/nasa13
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa13", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa13.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa13.local");
  ...
  // ota:
  //   password: ac2d0976a47a02339c31ca8da8d435e7
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("ac2d0976a47a02339c31ca8da8d435e7");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: oJs6rXSWpRhzSAhUSYtg3pP47JyfA82wBaiafusAWA8=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({160, 155, 58, 173, 116, 150, 165, 24, 115, 72, 8, 84, 73, 139, 96, 222, 147, 248, 236, 156, 159, 3, 205, 176, 5, 168, 154, 126, 235, 0, 88, 15});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA13");
