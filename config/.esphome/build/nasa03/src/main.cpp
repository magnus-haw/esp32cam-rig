...
void setup() {
  ...
  // esphome:
  //   name: nasa03
  //   build_path: .esphome/build/nasa03
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa03", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa03.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa03.local");
  ...
  ota_otacomponent->set_auth_password("99bd1ab6ce4628bffb6b42c2a399b807");
  ...
  api_apiserver->set_noise_psk({133, 35, 246, 23, 164, 76, 249, 102, 201, 177, 62, 183, 166, 16, 59, 243, 218, 108, 65, 198, 22, 24, 68, 144, 160, 184, 243, 63, 207, 150, 9, 29});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA03");
