...
void setup() {
  ...
  // esphome:
  //   name: nasa15
  //   build_path: .esphome/build/nasa15
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa15", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa15.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa15.local");
  ...
  // ota:
  //   password: 036bf63bf83b21432c46418d7d1174c6
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("036bf63bf83b21432c46418d7d1174c6");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: 8Gx3TPUYahEHVLSsONJDG5ifFJavvgPsSefhDTXqe2s=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({240, 108, 119, 76, 245, 24, 106, 17, 7, 84, 180, 172, 56, 210, 67, 27, 152, 159, 20, 150, 175, 190, 3, 236, 73, 231, 225, 13, 53, 234, 123, 107});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA15");
