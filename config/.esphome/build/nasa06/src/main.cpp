...
void setup() {
  ...
  // esphome:
  //   name: nasa06
  //   build_path: .esphome/build/nasa06
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa06", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa06.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa06.local");
  ...
  // ota:
  //   password: 85e39cdb934e865ded8b4b1364140e8e
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("85e39cdb934e865ded8b4b1364140e8e");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: aQ5UMysTqSqFKzKMYGfYkAHVpK25xVZdeJ5lzehHnE8=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({105, 14, 84, 51, 43, 19, 169, 42, 133, 43, 50, 140, 96, 103, 216, 144, 1, 213, 164, 173, 185, 197, 86, 93, 120, 158, 101, 205, 232, 71, 156, 79});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA06");
