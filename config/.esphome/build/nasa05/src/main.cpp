...
void setup() {
  ...
  // esphome:
  //   name: nasa05
  //   build_path: .esphome/build/nasa05
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa05", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa05.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa05.local");
  ...
  ota_otacomponent->set_auth_password("6e907e60a1b32b05ab7a3576d99fd488");
  ...
  api_apiserver->set_noise_psk({159, 104, 214, 113, 42, 110, 171, 112, 11, 138, 15, 170, 159, 250, 93, 63, 2, 62, 173, 207, 98, 157, 233, 130, 192, 134, 110, 201, 249, 233, 30, 237});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA05");
