...
void setup() {
  ...
  // esphome:
  //   name: nasa18
  //   build_path: .esphome/build/nasa18
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa18", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa18.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa18.local");
  ...
  // ota:
  //   password: 0901ef1e6cd002ccc479065ee04ac868
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("0901ef1e6cd002ccc479065ee04ac868");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: Fjety+bdCHc27yN/3mqiCVmlDdUQMVXzPM0fYeLjO74=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({22, 55, 173, 203, 230, 221, 8, 119, 54, 239, 35, 127, 222, 106, 162, 9, 89, 165, 13, 213, 16, 49, 85, 243, 60, 205, 31, 97, 226, 227, 59, 190});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA18");
