...
void setup() {
  ...
  // esphome:
  //   name: nasa20
  //   build_path: .esphome/build/nasa20
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa20", __DATE__ ", " __TIME__, false);
  // light:
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: 10.42.0.40
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("10.42.0.40");
  wifi::WiFiAP wifi_wifiap = wifi::WiFiAP();
  wifi_wifiap.set_ssid("shadowfax");
  wifi_wifiap.set_password("shadowfax");
  wifi_wifiap.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(10, 42, 0, 40),
      .gateway = network::IPAddress(10, 42, 0, 1),
  ...
  // ota:
  //   password: 2c30457046f330337bc35afc7b9a40ad
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("2c30457046f330337bc35afc7b9a40ad");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: btD2xvDyeXbQrGyv9gLiFE1PQl2zZ/csdki/3Fp+bn4=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({110, 208, 246, 198, 240, 242, 121, 118, 208, 172, 108, 175, 246, 2, 226, 20, 77, 79, 66, 93, 179, 103, 247, 44, 118, 72, 191, 220, 90, 126, 110, 126});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA20");
