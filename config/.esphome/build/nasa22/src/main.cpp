...
void setup() {
  ...
  // esphome:
  //   name: nasa22
  //   build_path: .esphome/build/nasa22
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa22", __DATE__ ", " __TIME__, false);
  // light:
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  ...
  // ota:
  //   password: 5f1788e41a9325c76e51dc5c36c8cdc9
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("5f1788e41a9325c76e51dc5c36c8cdc9");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: UqDLQFkVdj2nIy3NCKrwkW9bx2J2TMGFIgHihBmbThU=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({82, 160, 203, 64, 89, 21, 118, 61, 167, 35, 45, 205, 8, 170, 240, 145, 111, 91, 199, 98, 118, 76, 193, 133, 34, 1, 226, 132, 25, 155, 78, 21});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA22");
