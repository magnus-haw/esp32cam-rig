...
void setup() {
  ...
  // esphome:
  //   name: nasa12
  //   build_path: .esphome/build/nasa12
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa12", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa12.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa12.local");
  ...
  // ota:
  //   password: 28ab1ac88e7a729f7d7b390e944dd003
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("28ab1ac88e7a729f7d7b390e944dd003");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: qYOPTmrvc6k9+4s91tkFmjN4yRfCh8iAfKZKw9ZalqI=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({169, 131, 143, 78, 106, 239, 115, 169, 61, 251, 139, 61, 214, 217, 5, 154, 51, 120, 201, 23, 194, 135, 200, 128, 124, 166, 74, 195, 214, 90, 150, 162});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA12");
