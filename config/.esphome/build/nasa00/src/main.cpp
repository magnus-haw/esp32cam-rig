...
void setup() {
  ...
  // esphome:
  //   name: nasa00
  //   build_path: .esphome/build/nasa00
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa00", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: nasa00.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa00.local");
  ...
  wifi_wifiap.set_ssid("Nasa0 Fallback Hotspot");
  wifi_wifiap.set_password("CJKHtyiGuGS6");
  ...
  ota_otacomponent->set_auth_password("0e6fa19a9f5b70b9e2dd9630eadf82a7");
  ...
  api_apiserver->set_noise_psk({196, 128, 10, 219, 252, 43, 24, 244, 9, 29, 8, 167, 164, 143, 235, 199, 179, 86, 251, 150, 67, 38, 238, 159, 240, 180, 3, 95, 138, 149, 208, 163});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA0");
