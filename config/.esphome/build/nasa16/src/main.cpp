...
void setup() {
  ...
  // esphome:
  //   name: nasa16
  //   build_path: .esphome/build/nasa16
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("nasa16", __DATE__ ", " __TIME__, false);
  // light:
  // text_sensor:
  // logger:
  //   id: logger_logger
  ...
  //     id: wifi_wifiap
  //     priority: 0.0
  //   use_address: nasa16.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("nasa16.local");
  ...
  // ota:
  //   password: 5767d2587a62489ae3b11255de63f686
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 3232
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("5767d2587a62489ae3b11255de63f686");
  ...
  //   password: MyPassword
  //   encryption:
  //     key: +hzLQu3LoEMyDRUDvoL3HO06Nh3bsVAWaWjAQICw3B0=
  //   id: api_apiserver
  //   port: 6053
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({250, 28, 203, 66, 237, 203, 160, 67, 50, 13, 21, 3, 190, 130, 247, 28, 237, 58, 54, 29, 219, 177, 80, 22, 105, 104, 192, 64, 128, 176, 220, 29});
  // esp32:
  //   board: esp32cam
  //   framework:
  //     version: 1.0.6
  ...
  esp32_camera_esp32camera->set_name("NASA16");
